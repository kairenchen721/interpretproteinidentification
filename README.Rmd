...
In theory, cytoscape [4] can do this, (since it is a visualizer for any network), but file reading (idXML or osw [1] is not an supported file format) and processing (having to click many thing in the graphical user interface, or run a few command in the command line interface) may a slight annoyance.
This package solve cytoscape's limitation through its simplicity and short learning phase. 
